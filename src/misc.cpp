/*
  FireEngine, a UCI chess playing engine derived from stockfish
  Copyright (C) 2025-2030 The developers
*/
...
std::string engine_version_info() {
    std::stringstream ss;
    ss << "FireEngine " << version << std::setfill('0');
...
std::string engine_info(bool to_uci) {
    return engine_version_info() + (to_uci ? "\nid author " : " by ")
         + "the developers (see AUTHORS file)";
}
